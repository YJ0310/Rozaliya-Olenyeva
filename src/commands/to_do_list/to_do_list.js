...
module.exports = {
    ...
    async execute(interaction, options) {
        try {
            ...
            try {
                interaction.editReply({ content: `Info: Kindly click the \`close\` button after you edit your data, the data will save after the panel close.` })
                ...
                collector.on(`collect`, async message => {
                    ...
                    // limit data
                    if (to_do_list.tasks.length > 5) {
                        message.reply(`You can only have 5 slots only. Press the help button under the panel to find how to get more slots`); return to_do_list.tasks.length = 5;
                    }
                    // map the to_do_list.task
                ...
                button_collector.on(`collect`, async button_interaction => {
                    ...
                    await button_interaction.deferReply({ ephemeral: true });
                    ...
                    if (buttonId === `close`) {
                        ...
                        return button_interaction.editReply(`Panel closed`);
                    ...
                    if (buttonId === `clear`) {
                        ...
                        clear_mode_selection_collector.on(`collect`, async clear_mode_selection_interaction => {
                            ...
                            await clear_mode_selection_interaction.deferReply({ephemeral: true});
